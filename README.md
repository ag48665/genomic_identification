...
## Synthetic Admixed Genome Analysis

A synthetic admixed genome was generated by combining genomic profiles from European (EUR) and African (AFR) ancestry samples.

PCA visualization demonstrates how admixed genomes occupy intermediate regions within the latent population structure space.

![Synthetic Admixed PCA](figures/synthetic_admixed_pca.png)
